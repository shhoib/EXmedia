...
const LandingPage = () => {
  return (
    <div>
     ...
     <div className="bg-gradient-to-b from-black to-zinc-900 pt-9">
         <Container>
            <div className="flex items-center">
             <div className="flex flex-col items-center">
                <div className="overflow-hidden flex items-center justify-center rounded-md relative before:absolute before:bg-red-500 before:w-[120%] before:h-1/2 before:animate-[spin_6s_ease-in-out_infinite] after:absolute after:inset-[2px] px-4 py-2  after:bg-black after:rounded-md">
