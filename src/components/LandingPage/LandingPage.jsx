...
const LandingPage = () => {
  return (
    <div>
     <div className="bg-black flex flex-col md:flex-row lg:flex-row items-center h-full p-7 relative md:p-3">
            ...
            <div className="z-10 flex flex-col items-center justify-center text-center md:text-start md:items-start">
            <h1 className="text-4xl text-white font-bold p-3 pt-14 drop-shadow-[0_5px_5px_rgb(91,20,20)]">CRAFTING <br/> BRAND IDENTITY <br/> CAPTURING MOMENTS</h1>
     ...
     <div className="bg-gradient-to-b from-black to-zinc-950 flex flex-col items-center pb-7">
